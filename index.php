...
?>
	...
	<div class="table-responsive" id="content" style="padding:0%">
			<table class="ctable">
				...
				<tr>
					<td><a href="form.php"><img class ="img-responsive" id="bmw650" height="200" width="280" src="bmw650.jpg"  alt="BMW 650" title="Click for more info" ></a></td>
				...
				<tr>
					<td><a href="form.php"><img id="bmw740" height="200" width="280" src="bmw740.jpg"  alt="BMW 740" title="Click for more info"></a></td>
				...
				<tr>
					<td><a href="form.php"> <img id="bmwm5" src="bmwm5.jpg" height="200" width="280" alt="BMW M5" title="Click for more info"></a></td>
				...
				<tr>
					<td><a href="form.php"><img id="bmw740h" src="bmw740h.jpg" height="200" width="280" alt="BMW 740" title="Click for more info"></a></td>
					<td>BMW 740 <br/> (3.0) d TwinPower Turbo A <br/> xDrive F01 Sedan</td>
					<td>2012</td>
					<td>3 000</td>
					<td>149 900 €</td>
